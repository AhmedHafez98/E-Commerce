...
<div class="container">
    <form method="post" action="#" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="first_name" value ="Product1" class="form-control input-lg" />
            </div>
        </div>
        <br />
        <br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="first_name"value ="3241" class="form-control input-lg" />
            </div>
        </div>
        <br />
        <br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="first_name" value ="5" class="form-control input-lg" />
            </div>
        </div>
        <br />
        <br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                <img src={{ asset ('category_image.png')}} class="img-thumbnail" width="100" />
